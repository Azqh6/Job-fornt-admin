...
<Dialog
    ...
    >
      ...
      <el-form-item label="请求路径" prop="menuUrl" v-if="formData.menuType==0">
        <el-input
          :maxLength="50"
          v-model="formData.menuUrl"
          placeholder="eg:/settings/menu"
          clearable
        >
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="排序" prop="sort">
        <el-input v-model="formData.sort" :maxLength="10" clearable></el-input>
      </el-form-item>
    </el-form>
    </Dialog>
</template>
